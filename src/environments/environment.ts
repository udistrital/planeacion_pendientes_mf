...
export const environment = {
  ...
  //SERVICES PLANEACIÓN
  // PLANES_CRUD: 'http://localhost:8080/', //http://pruebasapi2.intranetoas.udistrital.edu.co:8523/
  // PLANES_MID: 'http://localhost:8081/v1/', //http://pruebasapi2.intranetoas.udistrital.edu.co:8524/v1/
  ...
  PLANEACION_SEGUIMIENTO_MID: 'http://localhost:8525/v1/',
